...
public class SparkMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        put(Path.Web.BLOCK_UNBLOCK, ProfileController.changeBlockStatus);
        ...
        put(Path.Web.PRIVATE_PUBLIC, ProfileController.changeProfileStatus);
        ...
        post(Path.Web.ADD_COMMENT, ProfileController.addComment);
        delete(Path.Web.DELETE_COMMENT, ProfileController.deleteComment);
    }
}
