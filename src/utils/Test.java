...
public class Test {
    public static void generateData() {
        ...
        Message m1 = new Message(0L, "Gdes brate", new Date().getTime(), "mirko", "test");
        Message m2 = new Message(1L, "Evo sta ima", new Date().getTime(), "test", "mirko");
        Message m3 = new Message(2L, "Eo nista kod tebe?", new Date().getTime(), "mirko", "test");
        Message m4 = new Message(3L, "Caoos", new Date().getTime(), "ines", "mirko");
        Message m5 = new Message(4L, "Eo, kod tb", new Date().getTime(), "mirko", "ines");
        Message m6 = new Message(5L, "Nis, kod tb?", new Date().getTime(), "ines", "mirko");
        Message m7 = new Message(6L, "Admin ovde test", new Date().getTime(), "admin", "test");
        Message m8 = new Message(7L, "Drugi admin ovde, ali ti ne bi trebao videti razliku", new Date().getTime(), "zokster", "test");
        m.add(m1);m.add(m2);m.add(m3);m.add(m4);m.add(m5);m.add(m6);m.add(m7);m.add(m8);

        List<Comment> c =new ArrayList<>();
        Comment c1 = new Comment(0L, l, new Date().getTime(), "mirko");
        Comment c2 = new Comment(0L, "dubokoumno", new Date().getTime(), "test");
        Comment c3 = new Comment(4L, "pucas", new Date().getTime(), "test");
        Comment c4 = new Comment(5L, "najjaci sam", new Date().getTime(), "ines");
        Comment c5 = new Comment(8L, "dobra fotka", new Date().getTime(), "ines");
        Comment c6 = new Comment(11L, "volim krek", new Date().getTime(), "mirko");
        Comment c7 = new Comment(13L, "smradina sam najveca. Gradjanski rat u azerbejdzanu idegaaas", new Date().getTime(), "test");
        c.add(c1);c.add(c2);c.add(c3);c.add(c4);c.add(c5);c.add(c6);c.add(c7);

        List<FriendRequest> f = new ArrayList<>();
        FriendRequest f1 = new FriendRequest(new Date().getTime(), "mirko", "ines");
        f1.setStatus(FriendRequestStatus.Accepted);
        FriendRequest f2 = new FriendRequest(new Date().getTime(), "test", "mirko");
        f2.setStatus(FriendRequestStatus.Accepted);
        FriendRequest f3 = new FriendRequest(new Date().getTime(), "test", "ines");
        f3.setStatus(FriendRequestStatus.Rejected);
        FriendRequest f4 = new FriendRequest(new Date().getTime(), "test", "ines");
